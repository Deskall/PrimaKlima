				...
				<a href="$ContentImage.getSourceURL" class="dk-lightbox" data-caption="$ContentImage.Description">
					<% if $FullWidth %>
						...
						<% else %>
							...
							<img data-src="$ContentImage.FitMax(500,350).URL"
							     data-srcset="$ContentImage.FitMax(500,350).URL 500w,
							                  $ContentImage.FitMax(1000,500).URL 1000w,
							                  $ContentImage.FitMax(1500,500).URL 1500w,
							                  $ContentImage.FitMax(2500,1000).URL 2500w"
					...
					<% else %>
						...
						<% else %>
							...
							<img data-src="$ContentImage.FitMax(500,350).URL"
							     data-srcset="$ContentImage.FitMax(500,350).URL 500w,
							                  $ContentImage.FitMax(1000,500).URL 1000w,
							                  $ContentImage.FitMax(1200,500).URL 1200w"
