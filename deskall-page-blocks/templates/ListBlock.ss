<div class="uk-grid-small <% if ItemAlign == "right" %>uk-flex-wrap-reverse<% end_if %>" data-uk-grid>
    <% loop Items %>
    <div class="uk-flex uk-width-1-2 uk-width-1-3@s uk-width-1-4@m uk-width-1-5@l">
    ...
    <div class="uk-flex uk-width-1-2 uk-width-2-3@s uk-width-3-4@m uk-width-4-5@l ">
