    ...
    <ul class="uk-slideshow-items" <% if Height == "viewport" %>data-uk-height-viewport="<% if MinHeight > 0 %>min-height:$MinHeight;<% end_if %> <% if MaxHeight > 0 %>max-height:$MaxHeight;<% end_if %>"<% end_if %>>
        ...
        <li>
           ...
           <% if Effect == "kenburns" %><div class="uk-position-cover uk-animation-kenburns $EffectOptions"><% end_if %>
                ...
                <img src="$Image.FocusCropHeight($Top.ImageHeight).URL" data-srcset="$Image.FocusCropHeight($Top.ImageHeight).URL 320w, $Image.FocusCropHeight($Top.ImageHeight).URL 650w, $Image.FocusCropHeight($Top.ImageHeight).URL 1200w, $Image.FocusCropHeight($Top.ImageHeight).URL 2500w" alt="" data-uk-cover data-sizes="100vw" data-uk-img>
                ...
                <div class="dk-slide-text-container dk-overlay $Background uk-height-1-1 ">
                    <div class="uk-container uk-height-1-1 <% if $Top.FullWidth %>uk-container-expand<% end_if %>">
                        <div class="uk-position-relative uk-height-1-1">
                            <div class="$TextPosition $TextBackground $TextWidth <% if TextOpacity %>uk-overlay<% end_if %> <% if TextBackground != "no-bg" %>uk-padding-small<% end_if %>">
