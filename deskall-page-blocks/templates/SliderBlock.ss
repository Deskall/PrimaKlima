    ...
    <ul class="uk-slideshow-items" <% if Height == "viewport" %>data-uk-height-viewport="<% if MinHeight > 0 %>min-height:$MinHeight;<% end_if %> <% if MaxHeight > 0 %>max-height:$MaxHeight;<% end_if %>"<% end_if %>>
        ...
        <li>
           ...
           <% if Effect == "kenburns" %><div class="uk-position-cover uk-animation-kenburns $EffectOptions"><% end_if %>
                ...
                <img src="$Image.FocusFill(1200,$Top.ImageHeight).URL" data-srcset="$Image.FocusFill(320,$Top.ImageHeight).URL 320w, $Image.FocusFill(650,$Top.ImageHeight).URL 650w, $Image.FocusFill(1200,$Top.ImageHeight).URL 1200w, $Image.FocusFill(2500,$Top.ImageHeight).URL 2500w" alt="" data-sizes="100vw" data-uk-img>
