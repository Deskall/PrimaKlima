...
<div class="uk-position-relative uk-visible-toggle uk-light" data-uk-slideshow>
    ...
    <ul class="uk-slideshow-items">
        <% loop ActiveSlides %>
        <li>
            <img src="$Image.ScaleWidth(650).URL" data-srcset="$Image.ScaleWidth(650).URL 650w, $Image.ScaleWidth(2500).URL 1300w" alt="" data-uk-cover data-srcset="" data-sizes="(min-width: 650px) 650px, 100vw">
        </li>
        <% end_loop %>
    </ul>
