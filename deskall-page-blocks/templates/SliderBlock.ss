    ...
    <ul class="uk-slideshow-items" <% if Height == "viewport" %>data-uk-height-viewport="<% if MinHeight > 0 %>min-height:$MinHeight;<% end_if %> <% if MaxHeight > 0 %>max-height:$MaxHeight;<% end_if %>"<% end_if %>>
        ...
        <li>
           ...
           <% if Effect == "kenburns" %><div class="uk-position-cover uk-animation-kenburns $EffectOptions"><% end_if %>
                ...
                <% else %>
                    <% if Image.exists %> 
                    <img  data-src="$Image.FitMax(400,$Image.HeightForWidth(400)).Link" data-srcset="$Image.FitMax(400,$Image.HeightForWidth(400)).Link 0w, $Image.FitMax(800,$Image.HeightForWidth(800)).Link 600w, $Image.FitMax(1000,$Image.HeightForWidth(1000)).Link 800w, $Image.FitMax(1200,$Image.HeightForWidth(1200)).Link 1000w, $Image.FitMax(1500,$Image.HeightForWidth(1500)).Link 1300w, $Image.FitMax(2500,$Image.HeightForWidth(2500)).Link 1500w" alt="$Image.AtlTag($Title)" data-uk-cover sizes="100vw" data-uk-img>
                    <% end_if %>
                <% end_if %>
            <% if Effect == "kenburns" %></div><% end_if %>
            <% end_if %>
    ...
    <ul class="uk-slideshow-items" <% if Height == "viewport" %>data-uk-height-viewport="<% if MinHeight > 0 %>min-height:$MinHeight;<% end_if %> <% if MaxHeight > 0 %>max-height:$MaxHeight;<% end_if %>"<% end_if %>>
        ...
        <li>
           ...
           <% if Effect == "kenburns" %><div class="uk-position-cover uk-animation-kenburns $EffectOptions"><% end_if %>
                ...
                <% else %>
                    <% if Image.exists %> 
                    <img  data-src="$Image.Fit(400,$Image.HeightForWidth(400)).Link" data-srcset="$Image.Fit(400,$Image.HeightForWidth(400)).Link 0w, $Image.Fit(800,$Image.HeightForWidth(800)).Link 600w, $Image.Fit(1000,$Image.HeightForWidth(1000)).Link 800w, $Image.Fit(1200,$Image.HeightForWidth(1200)).Link 1000w, $Image.Fit(1500,$Image.HeightForWidth(1500)).Link 1300w, $Image.Fit(2500,$Image.HeightForWidth(2500)).Link 1500w" alt="$Image.AtlTag($Title)" data-uk-cover sizes="100vw" data-uk-img>
                    <% end_if %>
                <% end_if %>
            <% if Effect == "kenburns" %></div><% end_if %>
            <% end_if %>
