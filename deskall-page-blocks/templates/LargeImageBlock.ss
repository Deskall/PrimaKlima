	<% if Effect == "fixed" %>
	<div class="$Height uk-background-cover uk-background-fixed uk-light <% if Background %>$Background dk-overlay uk-background-blend-overlay<% end_if %> <% if Height == "viewport" %>uk-height-viewport<% end_if %>" 
