...
class BaseBlockExtension extends DataExtension implements i18nEntityProvider
{
    ...
    public function updateCMSFields(FieldList $fields){
        ...
        $fields->addFieldToTab('Root.LayoutTab', CompositeField::create(
            ...
            DropdownField::create('Background',_t(__CLASS__.'.BackgroundColor','Hintergrundfarbe'),SiteConfig::current_site_config()->getBackgroundColors())->setDescription(_t(__CLASS__.'.BackgroundColorHelpText','wird als overlay anzeigen falls es ein Hintergrundbild gibt.'))->addExtraClass('colors'),
