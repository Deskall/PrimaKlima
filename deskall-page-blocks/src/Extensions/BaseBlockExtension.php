...
class BaseBlockExtension extends DataExtension implements i18nEntityProvider
{
    ...
    public function updateCMSFields(FieldList $fields){
    	...
    	$fields->addFieldToTab('Root.LayoutTab',CompositeField::create(
            ...
            DropdownField::create('SectionPadding',_t(__CLASS__.'.SectionPadding','Vertical Abstand'),['' => 'Keine', 'uk-section-small' => 'klein', 'uk-section-medium' => 'medium','uk-section-large' => 'gross']),
