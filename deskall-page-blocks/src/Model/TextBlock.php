...
class TextBlock extends BaseElement implements Searchable
{
    ...
    public function getCMSFields()
    {
        ...
        $fields->FieldByName('Root.LayoutTab.TextLayout')->push(DropdownField::create('ImageWidth',_t(__CLASS__.'.ImageWidth','Bild Breite'),$this->getTranslatedSourceFor('LayoutBlock','widths'))->setDescription(_t('LayoutBlock.WidthDescription','Relative Breite im Vergleich zur Blockbreite'))->setValue('uk-width-1-1@s uk-width-1-3@m'));
