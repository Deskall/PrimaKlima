...
class GalleryBlock extends BaseElement implements Searchable
{
    ...
    public function getCMSFields()
    {
        ...
        $this->beforeUpdateCMSFields(function($fields) {
            ...
            $fields->addFieldToTab('Root.Main',UploadField::create('Images',_t(__CLASS__.'.Images','Bilder'))->setIsMultiUpload(true)->setFolderName($this->getFolderName())->displayIf('Type')->isEqualTo('images')->end(),'HTML');
