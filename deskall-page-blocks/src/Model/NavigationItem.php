...
class NavigationItem extends DataObject{
	...
	public function getCMSFields(){
		...
		$fields->addFieldToTab('Root.Main',HTMLDropdownField::create('BackgroundColor',_t(__CLASS__.'.BackgroundColor','Hintergrundfarbe'),SiteConfig::current_site_config()->getBackgroundColors())->addExtraClass('colors')->hideIf('ItemType')->isEqualTo('link'));
