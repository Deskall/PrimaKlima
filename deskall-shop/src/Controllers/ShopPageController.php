...
class ShopPageController extends PageController{
	...
	public function CheckoutForm(){
		...
		$actions = new FieldList(FormAction::create('payBill', _t('SHOP.BUY', 'Jetzt kostenpflichtig bestellen'))->addExtraClass('uk-button button-blau')->setUseButtonTag(true)->setButtonContent('<i class="uk-margin-small-right" data-uk-icon="cart"></i>'._t('SHOP.BUY', 'Jetzt kaufen')));
