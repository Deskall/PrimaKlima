	...
	<table class="uk-table uk-table-small uk-table-striped uk-table-middle uk-table-justify uk-table-responsive">
		...
		<tbody class="uk-table-divider">
			...
			<tr>
				...
				<td class="uk-text-truncate uk-table-expand">$Title<br/><%t Webshop.Price 'Stückpreis' %>: $PriceUnique.Nice</td><td class="uk-text-center@m">$Quantity</td><td class="uk-text-right">$Price.Nice</td>
			</tr>
			<% end_loop %>
			<% end_if %>
