<div id="cart-container" class="uk-position-fixed uk-position-center-right uk-position-z-index sidebar-menu">
	...
	<button class="uk-button uk-visible@m" type="button" data-uk-toggle="target: #offcanvas-usage-cart">Warenkorb (<span id="cart-articles-count">$countProducts</span>)<span class="uk-margin-small-left" data-uk-icon="icon: cart"></span></button>
