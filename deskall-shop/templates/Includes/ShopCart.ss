<div id="cart-container" class="uk-position-fixed uk-position-center-right uk-position-z-index sidebar-menu">
	...
	<button class="uk-button uk-visible@m" type="button" data-uk-toggle="target: #offcanvas-usage-cart">Warenkorb ($Products.count)<span class="uk-margin-small-left" data-uk-icon="icon: cart"></span></button>
