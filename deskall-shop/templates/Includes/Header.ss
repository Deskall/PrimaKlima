	...
	<div class="uk-container uk-container-medium uk-position-relative">
		...
		<nav class="uk-navbar-container uk-navbar-transparent" data-uk-navbar>
			...
			<div class="uk-navbar-right uk-hidden@m">
				<button class="uk-padding-remove dk-toggle-mobile-menu uk-margin-right" id="toggle-cart" data-uk-toggle="target: #cart-container" <% if $activeCart.countProducts == 0 %>hidden<% end_if %>>( <small id="cart-articles-count">$activeCart.countProducts</small> )<span class="uk-margin-small-left" data-uk-icon="icon: cart"></span></button>
