...
<table cellspacing="4" cellpadding="4" style="font-size:14px;">
	<tr><td><b><%t Webshop.OrderNumber 'Bestellung Nr.' %>$Nummer</b></td><td><%t Webshop.OrderNumber 'Datum' %> $Created.format('dd.MM.Y H:i')</td></tr>
	<tr><td><%t Webshop.PaymentType 'Zahlungsart' %></td><td>$PaymentResource</td></tr>
	<tr><td><%t Webshop.CustomerData 'Kunden Angaben' %></td><td>$printAddress</td></tr>
	<% if PaymentType == "bill" || PaymentType == "creditcart" %>
	<tr><td><%t Webshop.DeliveryAddress 'Lieferadresse' %></td><td>$printDeliveryAddress</td></tr>
	<% end_if %>
</table>

<table cellpadding="2" cellspacing="2">
	<thead>
		<tr style="background-color:#EEEEEE;color:#666666;"><th width="310" colspan="2"><%t Webshop.Product 'Produkt' %></th><th width="100" align="center"><%t Webshop.Quantity 'Menge' %></th><th width="120" align="right" style="text-align:right;padding-right:5px"><%t Webshop.Total 'Gesamt' %></th></tr>
	</thead>
	<tbody>
		<% loop Items %>
		<tr style="font-size:12px;padding-top:5px;padding-bottom:5px;"><td width="80"><img src="$Product.MainBild.FocusFill(80,80).absoluteURL" style="margin-right:10px;" width="80" height="80"/></td><td width="230">$Product.Title<br/>$PriceUnique.Nice</td><td width="100" align="center">$Quantity</td><td width="120" align="right">$Price.Nice</td></tr>
		<% end_loop %>
		<% if Voucher.exists %>
