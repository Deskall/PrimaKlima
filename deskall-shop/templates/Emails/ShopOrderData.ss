...
<table cellpadding="2" cellspacing="2">
	...
	<tbody>
		<% loop Items %>
		<tr style="font-size:12px;"  cellpadding="4" cellspacing="4"><td width="310" style="vertical-align:middle;"><img src="$Product.MainBild.FocusFill(80,80).absoluteURL" style="margin-right:10px;" width="80" height="80"/> $Product.Title</td><td width="100" align="center">$Quantity</td><td width="120" align="right">$Price</td></tr>
		<% end_loop %>
		<% if Voucher.exists %>
