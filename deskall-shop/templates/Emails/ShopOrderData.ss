...
<table cellpadding="2" cellspacing="2">
	...
	<tbody>
		<tr style="font-size:12px;"><td width="210">$Product.Title</td><td width="100" align="center">$Price</td><td width="100" align="center">$Quantity</td><td width="120" align="right">$OrderSubPrice</td></tr>
