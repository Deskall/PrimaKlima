			...
			<li class="account-tab" data-index="0">
				<h3><%t Checkout.ShopCartTitle 'Ihr Warenkorb' %></h3>
					...
					<div class="uk-flex uk-flex-between">
						...
						<a class="uk-button" data-step="forward"><%t Global.Forward 'Weiter' %><i class="uk-margin-small-left" data-uk-icon="chevron-right"></i></a>
					</div>
			</li>
			<% if Controller.activeCart.products.exists %>
			...
			<li class="account-tab" data-index="2">
				...
				<div class="uk-panel uk-background-muted uk-padding-small">
					...
					<div class="uk-flex uk-flex-left">
						...
						<a class="uk-button" data-check-voucher><%t Checkout.VoucherCheck 'Gutschein prüfen' %></a>
					</div>
				</div>
				<hr>
				<div class="uk-panel uk-background-muted uk-padding-small">
