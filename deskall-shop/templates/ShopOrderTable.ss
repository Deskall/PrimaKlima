...
<table cellspacing="2">
	<tr style="font-size:12px;"><td><%t Bill.BillNumber 'Rechnung Nr.' %> $Nummer</td><td><%t Bill.CustomerNumber 'Kunde Nr.' %> $Customer.Nummer</td><td align="right"><%t Bill.Date 'Datum:' %> $Created.format('dd.MM.Y')</td></tr>
</table>
<hr>
