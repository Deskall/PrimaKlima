...
<table cellpadding="2" cellspacing="2">
	...
	<tbody>
		<tr><td width="210">$Product.Title</td><td width="100" align="center">$Product.RunTimeTitle</td><td width="100" align="center">$Product.NumOfAdsTitle</td><td width="120" align="right">$OrderSubPrice</td></tr>
