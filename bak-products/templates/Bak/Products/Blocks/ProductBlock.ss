<ul data-uk-tab class="uk-margin-remove uk-child-width-expand">
    ...
    <li><div class="uk-width-1-1"><input data-search-products placeholder="<%t ProductOverviewPage.Name 'Name' %>" /><span class="uk-position-center-right uk-position-small"><i class="icon ion-ios-search"></i></span></div></li>
</ul>
