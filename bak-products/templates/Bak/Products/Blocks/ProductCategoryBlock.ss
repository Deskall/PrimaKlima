		...
		<div data-uk-height-match="target:h3;row:false;" class="uk-margin">
			<div data-uk-height-match="target:.dk-box-content .box-text;">
				<div class="uk-child-width-1-2@s uk-child-width-1-4@m uk-grid-medium" data-uk-grid data-uk-height-match="target:img;row:false;">
					<% loop ActiveBoxes %>
					...
					<div class="box uk-transition-toggle uk-height-1-1" tabindex="0">
		   				<a href="$Category.Link">
							...
							<div class="uk-margin-top dk-box-content">
						    	<div class="box-text"><%t HomePage.GOTOCATEGORY "zu den Produkte" %> <span data-uk-icon="icon:chevron-right;ratio:0.8"></span></div>
						    </div>
