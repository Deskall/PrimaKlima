          ...
          <div class="form-block">
           <div class="form-block">
            <form action="{$Link}SendProductForm" method="post" class="form-std">
              <span data-icon="&#xf213;"><input type="text" class="uk-input uk-margin-small" name="name" placeholder="Name *" required/></span>
              <span data-icon="&#xf26c;"><input type="text" class="uk-input uk-margin-small" name="firma" placeholder='<%t ProductPage.FIRMA "Firma" %>' /></span>
                ...
                <!--  <div class="dropdown" data-dropdown>
                  ...
                  <button class="uk-button uk-button-primary"><%t ProductPage.SENDENACHRICHT "Anfrage senden" %><span class="icon ion-chevron-right"></span></button>
