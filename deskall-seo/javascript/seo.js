...
(function($) {
		...
		$.entwine('ss', function($){
			...
			$('.cms-edit-form textarea[name=MetaDescription], .cms-edit-form input[name=MetaTitle]').entwine({
				// Constructor: onmatch
				onkeyup : function() {
		...
		function set_preview_google_search_result() {
			...
			var page_url_basehref = $('input[name="URLSegment"]').attr('data-prefix'),
				...
				page_title       = ($('#Form_EditForm_MetaTitle').val() != "") ? $('#Form_EditForm_MetaTitle').val() : $('#Form_EditForm_Title').val(),
