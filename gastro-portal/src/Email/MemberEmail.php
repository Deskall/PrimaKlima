 ...
 */
class MemberEmail extends Email
{
    /**
     * @var Member|null
     */
...
';
     ...
     * @param Member $member
     */
    public function __construct(Page $page,$member,$sender,$receiver,$subject,$body)
    {
        parent::__construct();
    ...
    public function getParsedString($string)
    {
        ...
        $variables = array(
            ...
            '$AccountLink' => MemberProfilePage::get()->first()->AbsoluteLink()
        );
