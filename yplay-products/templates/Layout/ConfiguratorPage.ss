				...
				<div class="uk-width-2-3@m">
					...
					<div class="uk-margin">
						<ol class="uk-text-small">
							<li>La vitesse disponible dépend de l’extension locale de la fibre optique et du routeur utilisé. Un raccordement Swisscom avec une ligne fibre optique jusque dans le logement est requis pour bénéficier de débits identiques en download.</li>
							<li>La réception des chaînes HD dépend de la puissance du raccordement.</li>
							<li>Valable 24 h/24 vers tous les réseaux fixes et mobiles de tous les pays de l’UE/Europe Ouest, USA (hors zones insulaires des Etats-Unis) et Canada.</li>
							<li>Appels vers le réseau fixe suisse 0.04/min. au tarif réduit, 0.08/min. au tarif normal. Appels vers le réseau mobile Swisscom 0.27/min. au tarif réduit, 0.32/min. au tarif normal. Appels vers le réseau mobile d’autres opérateurs 0.30/min. au tarif réduit, 0.35/min. au tarif normal. La facturation s’effectue par tranches de 10 centimes. Les appels/SMS vers des numéros Business, courts et spéciaux sont payants.</li>
							<li>Téléphonie de la Suisse vers l’UE/l’Europe de l’Ouest facturable séparément.</li>
							<li>Surf dans l’UE/l’Europe de l’Ouest jusqu’à 40 Go max. par mois, puis limitationde la vitesse à 128 kbit/s.</li>
						 	<li>Téléphonie de la Suisse vers l’UE/l’Europe de l’Ouest, les États-Unis, le Canada et d’autres payscomprise dans le prix. Téléphonie au sein de la zone de pays «Monde zone 1» incluse.Liste des pays sur swisscom.ch/roaming.</li>
						 </ol>
