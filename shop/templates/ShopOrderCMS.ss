...
<table cellpadding="2" cellspacing="2">
	...
	<tbody>
		...
		<% if not Product.Online %><tr><td colspan="3"><%t Product.TransportCost 'Transportkosten (pauschal Preis)' %></td><td align="right">$ProductConfig.TransportCost EUR</td></tr><% end_if %>
