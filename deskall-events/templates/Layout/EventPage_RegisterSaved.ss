				...
				<div class="element" id="event" data-event-id="$Date.ID">
					...
					<div class="uk-panel">
						...
						<table class="uk-table uk-table-small uk-table-responsive">
							...
							<tbody><tr><td>$Event.Title</td><td><i class="icon icon-calendar uk-margin-small-right"></i>$Date.Date</td><td><i class="icon icon-ios-location uk-margin-small-right"></i>$Date.City</td><td class="uk-text-right">$Order.Price.Nice</td></tr></tbody>
						</table>
