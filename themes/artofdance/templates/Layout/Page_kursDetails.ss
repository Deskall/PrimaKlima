		...
		<div class="uk-container">
			<div class="uk-grid-small uk-grid-match" data-uk-grid>
				...
				<div class="uk-width-3-4@m uk-width-4-5@l">
					   <div class="uk-flex uk-flex-left"><a href="$Parent.Link" class="uk-link uk-margin-right">$Parent.MenuTitle</a>»<a href="$Link" class="uk-link uk-margin-right">$kursData.GruppenTitel</a>»$kursData.KursIDTitelDatumVonDatumBis</div>
					      <h1>$Title</h1>
					      <div class="main-data">
