<div class="$Layout <% if isMobile  %> uk-hidden@m <% else %>uk-visible@m<% end_if %> $Class">
	 ...
	 <ul data-ic class="dk-nav-mobile uk-nav uk-nav-parent-icon <% if UseMenu %>$UseMenuOption<% end_if %>" data-uk-nav>
		<% if UseMenu %>
		<% loop Menu %>
				...
				<ul class="uk-nav-sub">
					...
					<li class="menu-section">
						<div class="uk-grid-small" data-uk-grid>
							<div class="uk-width-1-5"><img width="40" height="40" src="$Image.URL" class="menu-icon"></div>
