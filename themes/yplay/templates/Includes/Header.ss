					...
					<%-- 		<div class="uk-navbar-right">
							...
							<div class="uk-navbar-right">
								<ul class="uk-navbar-nav">
									...
									<li class="link"><a href="#" data-uk-toggle="#modal-notifications"><i class="uk-margin-small-right"  data-uk-icon="bell"></i><span class="uk-label uk-label-danger uk-border-rounded" >2</span><small>Meldungen</small></a></li>
