				...
				<nav class="uk-navbar-container uk-navbar-transparent uk-navbar-main uk-hidden@m" data-uk-navbar="dropbar: true;boundary-align:true;mode:click;">
					...
					<div class="uk-navbar-right">
								<ul class="uk-navbar-nav mobile-icon-nav">
									...
									<li class="link"><a href="#" class="uk-position-relative" data-uk-icon="bell" data-uk-toggle="#modal-notifications"><span class="uk-label uk-label-danger uk-border-rounded uk-position-bottom-right">2</span></a></li>
									<%-- <li class="link"><a href="#"><i class="fab fa-opencart uk-text-large uk-margin-small-right"></i><small>1 Meldung(s) im Warenkorb</small></a></li> --%>
