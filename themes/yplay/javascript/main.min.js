...
function initGmaps(a,d,b,e){var f=new google.maps.Geocoder;new google.maps.LatLng(0,0);b=$.parseJSON(b);var c=new google.maps.Map(document.getElementById(a),b);f.geocode({address:d},function(a,b){b==google.maps.GeocoderStatus.OK?c.setCenter(a[0].geometry.location):alert("Geocode was not successful for the following reason: "+b);(new google.maps.InfoWindow({content:e,position:a[0].geometry.location})).open(c)})}$(document).ready(function(){0<$(".google-map").length&&$('<script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCbrDquBmMxiRMZz6itPir8xKX7HLa7xZE&callback=loadmap">\x3c/script>').appendTo($("body"))});
$(document).ready(function(){$("[href *= '#']").each(function(){var a=$(this).attr("href");a=a.substr(0,a.indexOf("#"));window.location.pathname==a&&UIkit.scroll($(this),{offset:100})})});$(document).ready(function(){UIkit.update(document.body,type="update")});$(window).resize(function(){UIkit.update(document.body,type="update")});var gaProperty="UA-XXXXXXXX-X",disableStr="ga-disable-"+gaProperty;-1<document.cookie.indexOf(disableStr+"=true")&&(window[disableStr]=!0);
$('a[href$="#ga-optout"]').click(function(){document.cookie=disableStr+"=true; expires=Thu, 31 Dec 2099 23:59:59 UTC; path=/";window[disableStr]=!0;alert("Google Analytics wurde deaktiviert");return!1});
