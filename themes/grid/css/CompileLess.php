...
if($css_compiled){
	...
	$css_compiled = str_replace($_SERVER['DOCUMENT_ROOT']."/themes/images/backgrounds/","/themes/grid/css/src/images/backgrounds/",$css_compiled);
	$css_live = str_replace("url('../fonts","url('/themes/grid/fonts",$css_compiled);
