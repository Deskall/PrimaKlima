...
<div class="uk-position-relative" tabindex="-1" data-uk-slideshow="ratio: false;autoplay:true;autoplayInterval:5000;animation:fade;">
    <ul class="uk-slideshow-items" data-uk-height-viewport="offset-top: true; offset-bottom: 30;min-height:600">
    ...
    <div class="uk-position-center-left uk-position-medium">
    	<div class="uk-background-muted uk-padding uk-text-center uk-box-shadow-large uk-width-large uk-border-rounded">
