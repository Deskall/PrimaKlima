...
<div class="uk-position-relative" tabindex="-1" data-uk-slideshow="ratio: false;autoplay:true;autoplayInterval:5000;animation:fade">
    ...
    <div class="uk-position-center-left uk-position-medium">
    	<div class="BodyBackground uk-padding uk-text-center uk-box-shadow-large uk-width-large uk-border-rounded">
    		...
    		<form method="GET" action="$OfferPage.Link" class="finder-bar uk-grid-small uk-flex uk-flex-right uk-flex-middle uk-child-width-1-1" data-uk-grid>
    					...
    					<div>
    						<button class="uk-button button-PrimaryBackground uk-width-1-1 uk-flex uk-flex-middle"><span><%t FinderBar.SearchAction 'Jobs suchen' %></span><i class="icon icon-chevron-right uk-margin-small-left uk-text-small"></i></button>
    					</div>
    		</form>
    	</div>
    </div>
