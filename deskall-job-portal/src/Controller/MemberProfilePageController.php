...
class MemberProfilePageController extends PageController{
	...
	public function ProfilForm(){
		...
		$actions = new FieldList(FormAction::create('save', _t('MemberProfiles.SAVE', 'Speichern'))->addExtraClass('uk-button PrimaryBackground')->setUseButtonTag(true)->setButtonContent('<i class="icon icon-disc uk-margin-small-right"></i>'._t('MemberProfiles.SAVE', 'Speichern')));
