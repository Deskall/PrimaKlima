...
class MemberProfileExtension extends DataExtension
{
    ...
    public function getRegisterFields(){
        ...
        $fields->push(CheckboxField::create('AGB','AGB')->setRightTitle('<p class="uk-text-small">Hiermit bestätige ich, dass ich sowohl <a href="/" target="_blank">die Datenschutzerklärung</a> wie auch die AGB gelesen habe und mit beiden einverstanden bin.</p>'));
