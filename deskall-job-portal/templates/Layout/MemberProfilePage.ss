								...
								<div class="toggle-new-offer">
									...
									<div class="uk-margin uk-overflow-auto">
										...
										<table class="uk-table uk-table-small uk-table-justify">
											...
											<tr><td class="uk-table-expand">$Title</td><td>$RunTimeTitle</td><td>$Candidatures.count</td><td>$Status</td><td><a data-uk-cion="eye" href="$previewLink" target="_blank"></a></td><td>&nbsp;</td><td>&nbsp;</td></tr>
											<% end_loop %>
											</tbody>
										</table>
									</div>
