	...
	<div class="uk-container">
		...
		<div class="uk-margin">
			<div class="uk-flex uk-flex-center uk-flex-around">
				...
				<a href="$File.URL" class="uk-button button-PrimaryBackground"><i class="icon icon-print uk-margin-small-right"></i><%t Candidature.Print 'Bewerbung als PDF anzeigen' %></a>
