	...
	<div class="uk-container">
		...
		<div class="uk-margin">
			<div class="uk-flex uk-flex-center uk-flex-around">
				...
				<a href="$File.URL" class="uk-button WhiteBackground" target="_blank"><i class="icon icon-printer uk-margin-small-right"></i><%t Candidature.Print 'Bewerbung als PDF drücken' %></a>
