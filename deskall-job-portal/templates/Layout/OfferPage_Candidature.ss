	...
	<div class="uk-container">
		...
		<div class="uk-margin">
			<div class="uk-flex uk-flex-center uk-flex-around">
				<a href="mailto:{$Candidat.Email}?subject=<%t Candidature.ContactMailTilte 'Ihre Bewerbung für die Stellenangebot - $Top.SiteConfig.Title' %> {$Mission.Nummer}" class="uk-button button-PrimaryBackground"><i class="icon icon-ios-paperplane uk-margin-small-right"></i><%t Candidature.Answer 'Kontakt aufnehmen' %></a>
