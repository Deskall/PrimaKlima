				...
				<div id="Form_ProfilForm_Logo_Holder" class="field uk-margin-small">
					...
					<div class="uk-form-controls">
						...
						<div class="switch-container-{$Top.Record.ID} original-container-{$Top.Record.ID} uk-position-relative">
							...
							<div id="upload-photo-container-{$Top.Record.ID}" class="js-upload with-preview uk-placeholder uk-text-center uk-margin-remove switch-this" data-container=".original-container-{$Top.Record.ID}" data-field-name="LogoID" hidden data-allowed="*.(jpg|jpeg|gif|png)">
						...
						<div class="photo-profil-{$Top.Record.ID} uk-text-center">
							<div id="upload-photo-container-{$Top.Record.ID}" class="js-upload with-preview uk-placeholder uk-text-center uk-margin-remove" data-container=".photo-profil-{$Top.Record.ID}" data-field-name="LogoID" data-allowed="*.(jpg|jpeg|gif|png)">
								<div class="form-field">
									<span data-uk-icon="icon: cloud-upload"></span>
									<span class="uk-text-middle"><%t Member.ChangePicture 'Legen Sie ein Bild ab oder' %></span>
									<div data-uk-form-custom>
