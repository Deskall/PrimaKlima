				...
				<div id="Form_ApplicationForm_CV_Holder" class="field text uk-margin-small">
					...
					<div class="uk-form-controls">
						<div class="uk-margin-small">
							<div id="upload-CV" class="js-upload simple uk-placeholder uk-text-center" data-container="#cv-container" data-field-name="CVID" data-type="file" data-url="$Controller.Link">
