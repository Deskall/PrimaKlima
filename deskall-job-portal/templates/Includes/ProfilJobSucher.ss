									...
									<div class="uk-panel uk-background-muted uk-padding-small">
										...
										<div class="member-section-container">
											...
											<table class="uk-table uk-table-small uk-table-divider">
												...
												<tr><td>$Mission.Title</td><td>$Mission.Company</td><td>$Mission.City</td><td>$Created.Ago</td><td>$NiceStatus</td><td>$CV</td><td><a href="$Mission.Link" title="zur Stellenangebote" data-uk-tooltip><i class="icon icon-eye"></i></a></td></tr>
												<% end_loop %>
											</table>
											<% else %>
											...
											<% end_if %>
											<div class="uk-margin">
												<a href="$OfferPage.Link" class="uk-button button-PrimaryBackground"><%t JobSucher.toSearch 'Zum Job Suche' %></a>
											</div>
										</div>
									</div>
								</li>
