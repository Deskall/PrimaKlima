						...
						<div class="uk-margin">
							...
							<ul class="uk-switcher">
								...
								<li>
									...
									<table class="uk-table uk-table-responsive uk-table-small uk-table-border">
										...
										<tr><td>$Created.Date</td><td>$Position</td><td>$Results.count</td><td>$activeMatches.count</td><td><a href="$Link" class="uk-button button-PrimaryBackground uk-button-small" data-uk-tooltip="Anfrage wieder laufen"><i data-uk-icon="play"></i></a></td></tr>
										<% end_loop %>
										</tbody>
									</table>
									<% else %>
