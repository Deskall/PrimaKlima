										...
										<div class="toggle-new-offer">
											...
											<div class="uk-margin uk-overflow-auto">
												...
												<table class="uk-table uk-table-small uk-table-striped uk-table-justify">
													...
													<tr><td class="uk-table-expand">$Title</td><td>$PublishedDate.ago</td><td>$Candidatures.count</td><td>$NiceStatus</td><td><a href="$previewLink" target="_blank"><i class="icon icon-eye"></i></a></td><td><% if canEdit %><a href="{$Top.Link}inserat-bearbeiten/{$ID}"><i class="icon icon-edit"></i></a><% end_if %></td><td><% if canDelete %><a data-uk-toggle="target: #modal-delete-offer-{$ID}"><i class="icon icon-trash-a"></i></a><% end_if %></td><td><% if canPublish %><a data-uk-toggle="target: #modal-publish-offer-{$ID}"><i class="icon icon-ios-paperplane"></i></a><% end_if %></td></tr>
									...
									<div class="uk-panel uk-background-muted uk-padding-small">
										...
										<div class="member-section-container">
											...
											<table class="uk-table uk-table-small uk-table-divider">
												...
												<tr><td>$Candidat.Thumbnail</td><td>$Candidat.NiceAddress</td><td>$Mission.ShortDescription</td><td>$Created.Ago</td><td><a href="$previewLink" title="<%t Candidature.SeeCandidat 'Bewerbung ansehen' %>" class="icon icon-eye"></a></td><td><a href="$respondLink" title="<%t Candidature.Contact 'kontakt mit dem Bewerber aufnehmen' %>" class="icon icon-ios-paperplane" data-uk-tooltip></a></td><td><a data-delete title="<%t Candidature.Decline 'Bewerbung ablehnen' %>" class="icon icon-trash-a"></a></td></tr>
												<% end_loop %>
											</table>
											<% else %>
