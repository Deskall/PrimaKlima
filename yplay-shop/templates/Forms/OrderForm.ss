                            	 ...
                            	 <div class="uk-card uk-card-hover uk-box-shadow-medium uk-card-body uk-transition-toggle">
						           	...
						           	<table class="uk-table uk-table-small uk-table-hover">
						           		<% loop Children %>
							           		<% if hasOptions %>
								           		<% loop Options %>
								           		<tr><td class="uk-table-shrink"><input type="radio" class="uk-checkbox pseudo-checkbox" name="$Group.ProductCode" data-value="$ProductCode" <% if $inCart %>checked="checked"<% end_if %> ></td><td>$Title</td><td class="uk-text-right">$PrintPriceString</td></tr>
								           		<% end_loop %>
								           	<% else %>
