...
class CategoryDependency extends DataObject {
	...
	public function getCMSFields(){
		...
		$fields->insertAfter('Action', ListboxField::create('RequiredCategories',$this->fieldLabels()['RequiredCategories'], ProductCategory::get()->exclude('ID',$this->ParentID)->map('ID','Title'), $this->RequiredCategories())->setAttribute('data-placeholder','Bitte Kategorie(n) eingeben'));
