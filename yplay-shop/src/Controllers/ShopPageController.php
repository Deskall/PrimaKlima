      ...
      $form = new Form(
         ...
         new FieldList(
            ...
            CompositeField::create(
               ...
               DropdownField::create('PaymentTyp','Zahlungsart',['Email' => 'E-Mail Rechnung', 'Paper' => 'Papier Rechnung (Fr. 2.50 / Mt.)', 'Lastschriftverfahren' => 'Lastschriftverfahren','DebitDirect' => 'Debit Direct (Postfinance)','eBanking' => 'eBanking Rechnung'])->setEmptyString('Bitte wählen')->setValue('Email')->setAttribute('class','uk-select'),
