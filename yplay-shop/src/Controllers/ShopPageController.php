      ...
      $form = new Form(
         ...
         new FieldList(
            CompositeField::create(
               ...
               DateField::create('Birthday','Geburstdatum')->setValue($date)->setAttribute('minDate','1900.01.01')->setAttribute('maxDate',$date->format('Y.m.d'))->setAttribute('class','uk-input'),
