...
class ShopPageController extends PageController
{
   ...
   public function OrderForm(){
      ...
      $form = new Form(
         ...
         new FieldList(
            FormAction::create('doOrder', _t('SHOP.BUYNOW', 'Jetzt bestellen'))->addExtraClass('uk-button')->setButtonContent('<i data-uk-icon="cart"></i>'._t('SHOP.BUYNOW', 'Jetzt bestellen'))
         ),
