      ...
      $form = new Form(
         ...
         new FieldList(
            CompositeField::create(
               ...
               DateField::create('Birthday','Geburstdatum')->setValue($val->format('Y-m-d'))->setAttribute('minDate','1900.01.01')->setAttribute('maxDate',$max->format('Y.m.d'))->setAttribute('class','uk-input'),
