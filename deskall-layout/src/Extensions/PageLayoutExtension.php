...
class PageLayoutExtension extends DataExtension {
	...
	public function updateCMSFields(FieldList $fields){
	  ...
	  $fields->addFieldToTab('Root.Layout', HTMLDropdownField::create('MenuIcon',$this->owner->fieldLabels()['MenuIcon'], HTMLDropdownField::getSourceIcones(), '')->setEmptyString(_t('PageLayout.IconLabel','Wählen Sie ein Icon'))->addExtraClass('columns'));
