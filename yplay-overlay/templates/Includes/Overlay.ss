<div id="overlay-$ID" class="overlay-modal" data-uk-modal>
    <div class="uk-modal-dialog">
    	<div class="<% if BackgroundImage.exists %>uk-cover-container<% end_if %>" <% if BackgroundImage.exists %>style="background-image: url($BackgroundImage.FocusFill(600,800).URL);"<% end_if %>>
