...
class OverlayContentControllerExtension extends Extension
{
    ...
    public function doRate($data, Form $form){
        try {
            ...
            // $email->send();
            $form->sessionMessage('<h2>Vielen herzlichen Dank für Ihre Zeit</h2><p>Wir freuen uns, Sie zu unseren Kunden zählen zu dürfen. Sofern Sie noch kein Kunde sind, so freuen wir uns Sie in naher Zukunft als Kunden begrüssen zu dürfen.</p>', 'success');
