				...
				<td class="header container" align=""><!-- /content -->
					<div class="content">
						<table>
							<tbody>
								<tr>
									<td class="logo"><a title="$SiteConfig.Title" href="$AbsoluteBaseURL"><img src="{$SiteConfig.AbsoluteThemeDir}/img/logo-email.png" border="0" alt="$SiteConfig.Title"/></a></a></td>
								</tr>
								<% if $Header %>
