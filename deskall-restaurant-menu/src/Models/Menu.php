...
class Menu extends DataObject{
    ...
    public function getCMSFields()
    {
        ...
        $fields->addFieldToTab('Root.Main',LiteralField::create('HelpText','<div class="form-group field text">Verknüpfen Sie eine bestehende Speise oder schaffen Sie eine neue Speise.</div>'));
