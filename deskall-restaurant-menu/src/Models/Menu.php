...
class Menu extends DataObject{
    ...
    public function getCMSFields()
    {
        ...
        $fields->addFieldToTab('Root.Main',LiteralField::create('HelpText','<div class="field text"><label><i>Verknüpfen Sie eine bestehende Speise oder schaffen Sie eine neue Speise.</i></label></div>'));
